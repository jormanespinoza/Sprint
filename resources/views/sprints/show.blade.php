                ...
                <table class="table" id="tasks-table">
                    ...
                    <tbody>
                        @foreach($tasks as $task)
                            ...
                            @endphp
                            @if(Auth::user()->role_id != 4 || $task->status_id != 1)
                                <tr class="{{ $_status }}">
                                    ...
                                    <td class="task-table-text">
                                        @if(count($task->observations) > 0)
                                            <span class="glyphicon glyphicon-comment"></span> {{ count($task->observations) }}
                                        @endif
                                    </td>
                                    <td class="task-table-text">
                                                ...
                                                <div class="modal-content">
                                                        ...
                                                        @if(count($task->observations) > 0)
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10 col-md-offset-1">
                                                                    @foreach($task->observations->sortBy('created_at') as $observation)
                                                                        <div class="row task-comments">
                                                                            ...
                                                                            <div class="col-md-3 col-sm-10 col-xs-9">
                                                                                ...
                                                                                @endphp
                                                                                <span class="label label-{{ $_class }}"><b>{{ $observation->user->role->name }}</b></span><br>
                                                    ...
                                                    <div class="modal-footer">
                                                        <ul class="list-inline">
                                                            ...
                                                            @if($task->status_id == 5 && Auth::user()->role_id == 4)
                                                            ...
                                                            @else
                                                                @if(Auth::user()->role_id == 2)
                                                                    <button type="button" class="btn btn-primary" data-toggle="modal" role="button" data-target="#observationTaskModal-{{ $task->id }}" title="Comentar Tarea" data-dismiss="modal">
                                                                        <span class="glyphicon glyphicon-comment"></span> Comentar
                                                                    </button>
                                                                @endif
                                                            @endif
